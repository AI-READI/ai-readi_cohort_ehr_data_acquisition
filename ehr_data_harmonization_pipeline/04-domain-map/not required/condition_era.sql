...
CREATE TABLE IDENTIFIER(:databaseName ||'.04_condition_era') AS
...
(
	SELECT
		...
		, data_partner_id
		, payload
	FROM IDENTIFIER(:databaseName ||'.04_condition_occurrence') co
...
-- MAGIC timestamp_comment.comment(spark,dbname,'04_condition_era')
-- MAGIC
