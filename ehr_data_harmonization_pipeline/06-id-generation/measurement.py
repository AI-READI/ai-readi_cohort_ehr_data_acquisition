...
if dbutils.widgets.get("site")  == 'UAB':
    spark.sql(f"""
        CREATE OR REPLACE TABLE {databaseName}.06_measurement
        ...
        WITH join_conflict_id AS (
            ...
            FROM {databaseName}.04_measurement d
            LEFT JOIN {databaseName}.05_measurement lookup
        ...
        -- and global_id.measurement_datetime= v.visit_start_datetime 
...
timestamp_comment.comment(spark,databaseName,'06_measurement')
