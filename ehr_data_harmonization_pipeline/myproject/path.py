...
concept_relationship = "/N3C Export Area/OMOP Vocabularies/concept_relationship"


## Databricks adaptation 
root = '/user/hive/warehouse/'
transform = root
metadata = root
union_staging = root
concept = '/user/hive/warehouse/aireadi_ehr_omop_04292024/concept'
concept_relationship = "/user/hive/warehouse/aireadi_ehr_omop_04292024/concept"