...
def new_duplicate_rows_with_collision_bits_n3c(omop_domain, lookup_df, ctx, pk_col, full_hash_col):
...
def new_duplicate_rows_with_collision_bits(omop_domain, pk_col, full_hash_col):
